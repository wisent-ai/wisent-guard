...
def main():
    ...
    # Model configuration
    parser.add_argument("--model-path", type=str, default=None, help="Path to Qwen model (default: Qwen/Qwen2.5-7B)")
    parser.add_argument(
        "--batch-size",
        type=int,
        default=None,
    ...
    parser.add_argument("--cuda-device", type=int, default=0, help="CUDA device to use (default: 1)")
    parser.add_argument("--debug", action="store_true", help="Use Qwen2.5-0.5B for debugging with smaller datasets")

    # Dataset configuration
    parser.add_argument("--train-limit", type=int, default=None, help="Number of training samples to load")
    parser.add_argument(
        "--contrastive-pairs-limit", type=int, default=None, help="Number of contrastive pairs for steering training"
    )
    ...
    logger.info(
        f"   Train/Val/Test: {args.train_limit or defaults['train_limit']}/{args.val_limit or defaults['val_limit']}/{args.test_limit or defaults['test_limit']}"
    )
