...
def get_recommended_config_for_llama8b() -> Dict[str, Any]:
    ...
    return {
        ...
        "batch_size": 8,  # Recommended: ~22GB VRAM, good balance
        "max_new_tokens": 256,
        "layer_search_range": (15, 25),  # Layers 15-20 typically good for 8B models
        "train_limit": 200,
...
def main():
    ...
    parser.add_argument(
        "--val-limit", type=int, default=None, help="Number of validation samples to load (default: 100)"
    )
    parser.add_argument("--test-limit", type=int, default=None, help="Number of test samples to load (default: 200)")

    # Optimization configuration
    parser.add_argument(
        "--study-name", type=str, default=None, help="Optuna study name (default: llama_8b_steering_optimization)"
    )
    ...
    parser.add_argument(
        "--layer-range", type=int, nargs=2, default=None, help="Layer search range as two integers (default: 15 20)"
    )
