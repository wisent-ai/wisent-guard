...
def run_training(model, model_name, layer, scale, normalize):
    ...
    save_dir = f"./tests/goodevil/steering_output_{model_name}/best_steering_output_layer{layer}_scale{abs(scale)}_{normalize_str}"
...
configs = {
    ...
    "unsloth/Qwen3-4B-bnb-4bit": {
        ...
        "best_l_s_n": [(14, -4, False)] 
    },
    # 36 layers:
    "unsloth/Qwen2.5-3B-Instruct": {
        "model_name": "Qwen2.5-3B-Instruct",
        "best_l_s_n": [(14, -2, True)] 
    }
}
...
for model_path, cfg in configs.items():
    ...
    output_file = f"./tests/goodevil/best_results_{cfg['model_name']}.json"
