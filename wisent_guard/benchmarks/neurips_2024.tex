...
\rowcolor{catRC} XStoryCloze \cite{lin2021xstorycloze} & \LL & \textbf{2C-Flip} & commonsense \\
\rowcolor{catRC} XWinograd \cite{tikhonov2021xwinograd} & \LL & \textbf{2C-Flip} & commonsense \\
...
\rowcolor{catOther} PAWS-X \cite{yang2019pawsx} & \LL & \textbf{2C-Flip} & cross-lingual paraphrase \\
...
\rowcolor{catOther} XNLI \cite{conneau2018xnli} & \LL & \textbf{MC-FirstDistr} & cross-lingual NLI \\
