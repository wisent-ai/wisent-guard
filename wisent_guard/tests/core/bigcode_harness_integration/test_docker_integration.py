...
class TestDockerWisentGuardIntegration:
    ...
    def test_docker_mbpp_pipeline_integration(self, docker_mbpp_runner, sample_mbpp_data, docker_config):
    ...
    def test_docker_activation_extraction_simulation(self, docker_mbpp_runner, docker_config):
    ...
    def test_docker_batch_processing_for_training(self, docker_mbpp_runner, sample_mbpp_data, docker_config):
        """Test batch processing of MBPP tasks for classifier training."""
        # Process multiple tasks as would be done for training
        batch_results = docker_mbpp_runner.run_mbpp_batch(sample_mbpp_data, docker_config)
    ...
    def test_docker_environment_for_hf_eval(self, docker_mbpp_runner, docker_config, docker_environment):
...
class TestDockerPerformance:
    ...
    def test_docker_concurrent_execution(self, docker_mbpp_runner, sample_mbpp_data, docker_config):
...
class TestDockerCLIIntegration:
    ...
    def test_docker_cli_command_simulation(self, mock_run_task, docker_mbpp_runner, docker_config):
