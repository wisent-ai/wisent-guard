...
class MockDockerExecutor(DockerExecutor):
    """
    Mock Docker executor for testing without actual Docker.
    """

    def __init__(self, **kwargs):
        """Initialize mock executor without Docker checks."""
        self.image_name = kwargs.get("image_name", "wisent-guard-codeexec:latest")
        self.timeout = kwargs.get("timeout", 10)
        self.memory_limit = kwargs.get("memory_limit", "256m")
        self.cpu_limit = kwargs.get("cpu_limit", 0.5)
    ...
    def _ensure_image_exists(self):
        """Mock: Image always exists."""
        pass

    def execute_code(
        self, code: str, test_code: str = "", setup_code: str = ""
    ) -> Dict[str, Any]:
        """Mock execution - simulates successful execution."""
        # Simulate basic Python execution
        try:
            # For testing, just check if code is syntactically valid
